    ...
    *\
    ...
    def create_component_index_with_options(self, instance_id, name, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('CreateComponentIndex', '2017-06-13', 'HTTPS', 'POST', 'AK', '/openapi/instances/%s/component-index/%s' % (TeaConverter.to_unicode(instance_id), TeaConverter.to_unicode(name)), 'json', req, runtime)
        )
    ...
    def delete_component_index_with_options(self, instance_id, name, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DeleteComponentIndex', '2017-06-13', 'HTTPS', 'DELETE', 'AK', '/openapi/instances/%s/component-index/%s' % (TeaConverter.to_unicode(instance_id), TeaConverter.to_unicode(name)), 'json', req, runtime)
        )
    ...
    def delete_deprecated_template_with_options(self, instance_id, name, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DeleteDeprecatedTemplate', '2017-06-13', 'HTTPS', 'DELETE', 'AK', '/openapi/instances/%s/deprecated-templates/%s' % (TeaConverter.to_unicode(instance_id), TeaConverter.to_unicode(name)), 'json', req, runtime)
        )
    ...
    def describe_component_index_with_options(self, instance_id, name, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeComponentIndex', '2017-06-13', 'HTTPS', 'GET', 'AK', '/openapi/instances/%s/component-index/%s' % (TeaConverter.to_unicode(instance_id), TeaConverter.to_unicode(name)), 'json', req, runtime)
        )
    ...
    def describe_deprecated_template_with_options(self, instance_id, name, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeDeprecatedTemplate', '2017-06-13', 'HTTPS', 'GET', 'AK', '/openapi/instances/%s/deprecated-templates/%s' % (TeaConverter.to_unicode(instance_id), TeaConverter.to_unicode(name)), 'json', req, runtime)
        )
    ...
    def list_component_indices_with_options(self, instance_id, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('ListComponentIndices', '2017-06-13', 'HTTPS', 'GET', 'AK', '/openapi/instances/%s/component-index' % TeaConverter.to_unicode(instance_id), 'json', req, runtime)
        )
    ...
    def list_deprecated_templates_with_options(self, instance_id, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('ListDeprecatedTemplates', '2017-06-13', 'HTTPS', 'GET', 'AK', '/openapi/instances/%s/deprecated-templates' % TeaConverter.to_unicode(instance_id), 'json', req, runtime)
        )
    ...
    def trigger_network_with_options(self, instance_id, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('TriggerNetwork', '2017-06-13', 'HTTPS', 'POST', 'AK', '/openapi/instances/%s/actions/network-trigger' % TeaConverter.to_unicode(instance_id), 'json', req, runtime)
        )
    ...
    def update_component_index_with_options(self, instance_id, name, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('UpdateComponentIndex', '2017-06-13', 'HTTPS', 'PUT', 'AK', '/openapi/instances/%s/component-index/%s' % (TeaConverter.to_unicode(instance_id), TeaConverter.to_unicode(name)), 'json', req, runtime)
        )
    ...
    def update_white_ips_with_options(self, instance_id, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('UpdateWhiteIps', '2017-06-13', 'HTTPS', 'POST', 'AK', '/openapi/instances/%s/white-ips' % TeaConverter.to_unicode(instance_id), 'json', req, runtime)
        )
