    ...
    *\
    ...
    def update_description_with_options(self, instance_id, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest_with_form('UpdateDescription', '2017-06-13', 'HTTPS', 'POST', 'AK', '/openapi/instances/%s/description' % TeaConverter.to_unicode(instance_id), 'json', req, runtime)
        )
