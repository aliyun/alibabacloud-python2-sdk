...
class Client(OpenApiClient):
    ...
    *\
    ...
    def create_ldps_compute_group_with_options(self, request, runtime):
    ...
    def create_ldps_compute_group(self, request):
    ...
    def delete_ldps_compute_group_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.group_name):
            query['GroupName'] = request.group_name
    ...
    def delete_ldps_compute_group(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def get_client_source_ip_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.instance_id):
            query['InstanceId'] = request.instance_id
    ...
    def get_client_source_ip(self, request):
        runtime = util_models.RuntimeOptions()
        return self.get_client_source_ip_with_options(request, runtime)

    def get_engine_default_auth_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.instance_id):
            query['InstanceId'] = request.instance_id
    ...
    def get_engine_default_auth(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def get_ldps_compute_group(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def list_ldps_compute_groups_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.instance_id):
            query['InstanceId'] = request.instance_id
    ...
    def list_ldps_compute_groups(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def open_compute_engine_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
    ...
    def open_compute_engine(self, request):
        runtime = util_models.RuntimeOptions()
        return self.open_compute_engine_with_options(request, runtime)

    def open_compute_pre_check_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.cpu_limit):
            query['CpuLimit'] = request.cpu_limit
    ...
    def open_compute_pre_check(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def restart_ldps_compute_group_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.group_name):
            query['GroupName'] = request.group_name
    ...
    def restart_ldps_compute_group(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def update_ldps_compute_group(self, request):
        runtime = util_models.RuntimeOptions()
