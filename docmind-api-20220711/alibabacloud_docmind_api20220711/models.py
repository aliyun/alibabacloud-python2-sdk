...
class GetPageNumRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(GetPageNumRequest, self).to_map()
        if _map is not None:
            return _map
...
class GetPageNumResponseBodyData(TeaModel):
    ...
    def to_map(self):
        _map = super(GetPageNumResponseBodyData, self).to_map()
        if _map is not None:
            return _map
...
class GetPageNumResponseBody(TeaModel):
    def __init__(self, data=None, error_code=None, error_message=None, http_code=None, request_id=None, success=None):
        self.data = data  # type: GetPageNumResponseBodyData
    ...
    def to_map(self):
        _map = super(GetPageNumResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class GetPageNumResponse(TeaModel):
    def __init__(self, headers=None, status_code=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.status_code = status_code  # type: int
        self.body = body  # type: GetPageNumResponseBody
    ...
    def to_map(self):
        _map = super(GetPageNumResponse, self).to_map()
        if _map is not None:
            return _map
