    ...
    *\
    ...
    def describe_fault_diagnosis_overall_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeFaultDiagnosisOverallData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/diagnosis/describeFaultDiagnosisOverallData', 'json', req, runtime)
        )
    ...
    def describe_rtc_channel_users_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeRtcChannelUsers', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/channel/describeRtcChannelUsers', 'json', req, runtime)
        )
    ...
    def describe_channel_overall_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeChannelOverallData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/channel/describeChannelOverallData', 'json', req, runtime)
        )
    ...
    def describe_usage_os_sdk_version_distribution_stat_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeUsageOsSdkVersionDistributionStatData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/usage/describeUsageOsSdkVersionDistributionStatData', 'json', req, runtime)
        )
    ...
    def describe_ice_dur_period_by_day_sub_type_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeIceDurPeriodByDaySubType', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/ice/describeIceDurPeriodByDaySubType', 'json', req, runtime)
        )
    ...
    def describe_call_list_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeCallList', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/call/describeCallList', 'json', req, runtime)
        )
    ...
    def describe_quality_area_distribution_stat_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeQualityAreaDistributionStatData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/quality/describeQualityAreaDistributionStatData', 'json', req, runtime)
        )
    ...
    def describe_rtc_user_event_list_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeRtcUserEventList', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/call/describeRtcUserEventList', 'json', req, runtime)
        )
    ...
    def delete_app_exp_metric_rule_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DeleteAppExpMetricRule', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/config/deleteAppExpMetricRule', 'json', req, runtime)
        )
    ...
    def describe_end_point_event_list_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeEndPointEventList', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/call/describeEndPointEventList', 'json', req, runtime)
        )
    ...
    def describe_quality_distribution_stat_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeQualityDistributionStatData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/quality/describeQualityDistributionStatData', 'json', req, runtime)
        )
    ...
    def describe_call_list_test_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeCallListTest', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/call/describeCallListTest', 'json', req, runtime)
        )
    ...
    def describe_call_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeCall', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/call/describeCall', 'json', req, runtime)
        )
    ...
    def describe_app_follow_call_rule_list_with_options(self, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeAppFollowCallRuleList', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/config/describeAppFollowCallRuleList', 'json', req, runtime)
        )
    ...
    def describe_channel_area_distribution_stat_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeChannelAreaDistributionStatData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/channel/describeChannelAreaDistributionStatData', 'json', req, runtime)
        )
    ...
    def describe_app_exp_metric_rule_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeAppExpMetricRule', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/config/describeAppExpMetricRule', 'json', req, runtime)
        )
    ...
    def describe_rtc_channel_details_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeRtcChannelDetails', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/channel/describeRtcChannelDetails', 'json', req, runtime)
        )
    ...
    def describe_ice_dur_summary_overview_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeIceDurSummaryOverview', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/ice/describeIceDurSummaryOverview', 'json', req, runtime)
        )
    ...
    def describe_call_user_exp_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeCallUserExp', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/call/describeCallUserExp', 'json', req, runtime)
        )
    ...
    def describe_channel_join_info_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeChannelJoinInfo', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/channel/describeChannelJoinInfo', 'json', req, runtime)
        )
    ...
    def delete_app_follow_call_rule_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DeleteAppFollowCallRule', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/config/deleteAppFollowCallRule', 'json', req, runtime)
        )
    ...
    def describe_app_exp_metric_rule_list_with_options(self, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeAppExpMetricRuleList', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/config/describeAppExpMetricRuleList', 'json', req, runtime)
        )
    ...
    def describe_channel_top_pub_user_list_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeChannelTopPubUserList', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/channel/describeChannelTopPubUserList', 'json', req, runtime)
        )
    ...
    def describe_app_follow_call_rule_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeAppFollowCallRule', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/config/describeAppFollowCallRule', 'json', req, runtime)
        )
    ...
    def describe_usage_distribution_stat_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeUsageDistributionStatData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/usage/describeUsageDistributionStatData', 'json', req, runtime)
        )
    ...
    def describe_usage_area_distribution_stat_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeUsageAreaDistributionStatData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/usage/describeUsageAreaDistributionStatData', 'json', req, runtime)
        )
    ...
    def describe_end_point_metric_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeEndPointMetricData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/call/describeEndPointMetricData', 'json', req, runtime)
        )
    ...
    def describe_app_config_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeAppConfig', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/config/describeAppConfig', 'json', req, runtime)
        )
    ...
    def describe_usage_overall_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeUsageOverallData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/usage/describeUsageOverallData', 'json', req, runtime)
        )
    ...
    def update_app_exp_metric_rule_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('UpdateAppExpMetricRule', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/config/updateAppExpMetricRule', 'json', req, runtime)
        )
    ...
    def describe_fault_diagnosis_user_detail_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeFaultDiagnosisUserDetail', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/diagnosis/describeFaultDiagnosisUserDetail', 'json', req, runtime)
        )
    ...
    def describe_channel_distribution_stat_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeChannelDistributionStatData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/channel/describeChannelDistributionStatData', 'json', req, runtime)
        )
    ...
    def describe_channel_user_metrics_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeChannelUserMetrics', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/channel/describeChannelUserMetrics', 'json', req, runtime)
        )
    ...
    def describe_fault_diagnosis_factor_distribution_stat_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeFaultDiagnosisFactorDistributionStat', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/diagnosis/describeFaultDiagnosisFactorDistributionStat', 'json', req, runtime)
        )
    ...
    def describe_rtc_channel_list_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeRtcChannelList', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/channel/describeRtcChannelList', 'json', req, runtime)
        )
    ...
    def describe_fault_diagnosis_user_list_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeFaultDiagnosisUserList', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/diagnosis/describeFaultDiagnosisUserList', 'json', req, runtime)
        )
    ...
    def describe_rtc_channel_metric_list_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeRtcChannelMetricList', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/call/describeRtcChannelMetricList', 'json', req, runtime)
        )
    ...
    def describe_qoe_metric_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeQoeMetricData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/call/describeQoeMetricData', 'json', req, runtime)
        )
    ...
    def describe_pub_user_list_by_sub_user_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribePubUserListBySubUser', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/call/describePubUserListBySubUser', 'json', req, runtime)
        )
    ...
    def update_app_follow_call_rule_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('UpdateAppFollowCallRule', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/config/updateAppFollowCallRule', 'json', req, runtime)
        )
    ...
    def describe_quality_os_sdk_version_distribution_stat_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeQualityOsSdkVersionDistributionStatData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/quality/describeQualityOsSdkVersionDistributionStatData', 'json', req, runtime)
        )
    ...
    def describe_rtc_record_metric_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeRtcRecordMetricData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/record/describeRtcRecordMetricData', 'json', req, runtime)
        )
    ...
    def describe_quality_overall_data_with_options(self, request, headers, runtime):
        ...
        return TeaCore.from_map(
            ...
            self.do_roarequest('DescribeQualityOverallData', '2020-12-14', 'HTTPS', 'POST', 'AK', '/api/quality/describeQualityOverallData', 'json', req, runtime)
        )
