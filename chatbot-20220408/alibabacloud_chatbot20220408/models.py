...
class ChatResponseBodyMessagesCardList(TeaModel):
    def __init__(self, answer_source=None, msg_type=None, platform=None):
        # 区分答案类型：cardAnswer
    ...
    def to_map(self):
        _map = super(ChatResponseBodyMessagesCardList, self).to_map()
        if _map is not None:
            return _map
...
class ChatResponseBodyMessages(TeaModel):
    def __init__(self, answer_source=None, answer_type=None, card_list=None, knowledge=None, recommends=None,
                 text=None, title=None, voice_title=None):
        # 当AnswerType为Recommend时，此字段表示推荐的答案来源
        self.answer_source = answer_source  # type: str
        # 本条消息的类型
        self.answer_type = answer_type  # type: str
        # 当AnswerType为CardAnswer时，此字段包含机器人返回的Card的列表
        self.card_list = card_list  # type: list[ChatResponseBodyMessagesCardList]
...
class ListDsMenusRequest(TeaModel):
    def __init__(self, agent_key=None, instance_id=None, robot_env=None, source=None, tags=None):
        # 业务空间key,不设置则访问默认业务空间，key值在主账号业务管理页面获取
        self.agent_key = agent_key  # type: str
        # 机器人ID
        self.instance_id = instance_id  # type: str
        # 1-正式环境，2-测试环境（默认）
        self.robot_env = robot_env  # type: int
        # 业务来源标识：
    ...
    def to_map(self):
        _map = super(ListDsMenusRequest, self).to_map()
        if _map is not None:
            return _map
...
class ListDsMenusResponseBodyMenus(TeaModel):
    def __init__(self, tag=None, title=None, title_en=None, url=None):
        self.tag = tag  # type: str
        self.title = title  # type: str
        self.title_en = title_en  # type: str
    ...
    def to_map(self):
        _map = super(ListDsMenusResponseBodyMenus, self).to_map()
        if _map is not None:
            return _map
...
class ListDsMenusResponseBody(TeaModel):
    def __init__(self, ext=None, menus=None, request_id=None):
        self.ext = ext  # type: str
        self.menus = menus  # type: list[ListDsMenusResponseBodyMenus]
        self.request_id = request_id  # type: str
    ...
    def to_map(self):
        _map = super(ListDsMenusResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class ListDsMenusResponse(TeaModel):
    def __init__(self, headers=None, status_code=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.status_code = status_code  # type: int
        self.body = body  # type: ListDsMenusResponseBody
    ...
    def to_map(self):
        _map = super(ListDsMenusResponse, self).to_map()
        if _map is not None:
            return _map
...
class ListIntentRequest(TeaModel):
    def __init__(self, agent_key=None, instance_id=None, intent_name=None):
        # 业务空间key,不设置则访问默认业务空间，key值在主账号业务管理页面获取
        self.agent_key = agent_key  # type: str
        # 机器人ID
        self.instance_id = instance_id  # type: str
