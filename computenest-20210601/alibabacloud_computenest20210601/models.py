...
class GetServiceInstanceResponseBody(TeaModel):
    def __init__(self, outputs=None, status=None, template_name=None, update_time=None, progress=None,
                 parameters=None, request_id=None, service_instance_id=None, create_time=None, status_detail=None,
                 resources=None, service=None, operation_start_time=None, operation_end_time=None,
                 operated_service_instance_id=None, enable_instance_ops=None, is_operated=None):
...
class CreateServiceInstanceRequestOperationMetadata(TeaModel):
    def __init__(self, start_time=None, end_time=None, resources=None, service_instance_id=None):
...
class CreateServiceInstanceRequest(TeaModel):
    def __init__(self, region_id=None, service_id=None, service_version=None, parameters=None, client_token=None,
                 enable_instance_ops=None, enable_account_ops=None, template_name=None, operation_metadata=None):
        self.region_id = region_id  # type: str
        self.service_id = service_id  # type: str
...
class ListServiceInstancesResponseBodyServiceInstances(TeaModel):
    def __init__(self, status=None, outputs=None, update_time=None, parameters=None, service_instance_id=None,
                 create_time=None, status_detail=None, progress=None, resources=None, template_name=None,
                 operated_service_instance_id=None, service=None, operation_start_time=None, operation_end_time=None, enable_instance_ops=None):
        self.status = status  # type: str
        self.outputs = outputs  # type: str
        self.update_time = update_time  # type: str
        self.parameters = parameters  # type: str
