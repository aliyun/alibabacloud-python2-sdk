...
class CreateApplicationRequest(TeaModel):
    def __init__(self, access_token_validity=None, app_name=None, app_type=None, display_name=None,
                 ...
                 required_scopes=None, secret_required=None):
        ...
        self.required_scopes = required_scopes  # type: str
...
class CreateApplicationResponseBodyApplicationDelegatedScopePredefinedScopesPredefinedScope(TeaModel):
    def __init__(self, description=None, name=None, required=None):
...
class GetCredentialReportRequest(TeaModel):
    def __init__(self, max_items=None, next_token=None):
        ...
        self.max_items = max_items  # type: str
    ...
    def to_map(self):
        _map = super(GetCredentialReportRequest, self).to_map()
        if _map is not None:
            return _map
...
class GetCredentialReportResponseBody(TeaModel):
    def __init__(self, content=None, generated_time=None, is_truncated=None, next_token=None, request_id=None):
...
class UpdateApplicationRequest(TeaModel):
    def __init__(self, app_id=None, new_access_token_validity=None, new_display_name=None,
                 ...
                 new_required_scopes=None, new_secret_required=None):
        # The ID of the application.
        self.app_id = app_id  # type: str
        ...
        self.new_required_scopes = new_required_scopes  # type: str
