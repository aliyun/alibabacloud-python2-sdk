...
class Client(OpenApiClient):
    ...
    *\
    ...
    def get_prometheus_remote_action_token_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.cluster_id):
            query['ClusterId'] = request.cluster_id
    ...
    def get_prometheus_remote_action_token(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def install_eventer_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.cluster_id):
            query['ClusterId'] = request.cluster_id
    ...
    def install_eventer(self, request):
        runtime = util_models.RuntimeOptions()
