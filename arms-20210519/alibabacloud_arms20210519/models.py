...
class GetPrometheusRemoteActionTokenRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(GetPrometheusRemoteActionTokenRequest, self).to_map()
        if _map is not None:
            return _map
...
class GetPrometheusRemoteActionTokenResponseBody(TeaModel):
    ...
    def to_map(self):
        _map = super(GetPrometheusRemoteActionTokenResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class GetPrometheusRemoteActionTokenResponse(TeaModel):
    def __init__(self, headers=None, status_code=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.status_code = status_code  # type: int
        self.body = body  # type: GetPrometheusRemoteActionTokenResponseBody
    ...
    def to_map(self):
        _map = super(GetPrometheusRemoteActionTokenResponse, self).to_map()
        if _map is not None:
            return _map
    ...
    def from_map(self, m=None):
        ...
        if m.get('statusCode') is not None:
            self.status_code = m.get('statusCode')
        if m.get('body') is not None:
            temp_model = GetPrometheusRemoteActionTokenResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class GetStackRequest(TeaModel):
    def __init__(self, pid=None, region_id=None, rpc_id=None, trace_id=None):
        self.pid = pid  # type: str
        self.region_id = region_id  # type: str
        self.rpc_id = rpc_id  # type: str
        self.trace_id = trace_id  # type: str
...
class InstallCmsExporterRequest(TeaModel):
    def __init__(self, cluster_id=None, cms_args=None, region_id=None):
        self.cluster_id = cluster_id  # type: str
...
class InstallEventerRequest(TeaModel):
    def __init__(self, cluster_id=None, proxy_user_id=None, region_id=None):
        self.cluster_id = cluster_id  # type: str
        self.proxy_user_id = proxy_user_id  # type: str
        self.region_id = region_id  # type: str
    ...
    def to_map(self):
        _map = super(InstallEventerRequest, self).to_map()
        if _map is not None:
            return _map
...
class InstallEventerResponseBody(TeaModel):
    ...
    def to_map(self):
        _map = super(InstallEventerResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class InstallEventerResponse(TeaModel):
    def __init__(self, headers=None, status_code=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.status_code = status_code  # type: int
        self.body = body  # type: InstallEventerResponseBody
    ...
    def to_map(self):
        _map = super(InstallEventerResponse, self).to_map()
        if _map is not None:
            return _map
...
class ListDashboardsRequest(TeaModel):
    def __init__(self, cluster_id=None, cluster_type=None, dashboard_name=None, product=None, recreate_switch=None,
                 region_id=None, title=None):
        self.cluster_id = cluster_id  # type: str
        self.cluster_type = cluster_type  # type: str
