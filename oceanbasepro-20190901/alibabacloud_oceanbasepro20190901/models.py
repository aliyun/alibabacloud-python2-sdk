...
class DescribeInstanceResponseBodyInstance(TeaModel):
    def __init__(self, auto_renewal=None, auto_upgrade_ob_version=None, available_zones=None, create_time=None,
                 ...
                 expire_time=None, instance_class=None, instance_id=None, instance_name=None, is_latest_ob_version=None,
                 is_trust_ecs=None, maintain_time=None, ob_rpm_version=None, pay_type=None, resource=None, series=None,
