...
class DescribePhoneNumberRiskRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribePhoneNumberRiskRequest, self).to_map()
        if _map is not None:
            return _map
...
class DescribePhoneNumberRiskResponseBodyData(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribePhoneNumberRiskResponseBodyData, self).to_map()
        if _map is not None:
            return _map
...
class DescribePhoneNumberRiskResponseBody(TeaModel):
    def __init__(self, access_denied_detail=None, code=None, data=None, message=None, request_id=None):
        self.access_denied_detail = access_denied_detail  # type: str
        self.code = code  # type: str
        self.data = data  # type: DescribePhoneNumberRiskResponseBodyData
        self.message = message  # type: str
        self.request_id = request_id  # type: str
    ...
    def to_map(self):
        _map = super(DescribePhoneNumberRiskResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class DescribePhoneNumberRiskResponse(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribePhoneNumberRiskResponse, self).to_map()
        if _map is not None:
            return _map
