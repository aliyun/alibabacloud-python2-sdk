...
class Client(OpenApiClient):
    ...
    *\
    ...
    def cert_no_two_element_verification_with_options(self, request, runtime):
    ...
    def cert_no_two_element_verification(self, request):
    ...
    def describe_phone_number_analysis_transparent_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.auth_code):
            query['AuthCode'] = request.auth_code
    ...
    def describe_phone_number_analysis_transparent(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def describe_phone_number_risk_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.auth_code):
            query['AuthCode'] = request.auth_code
    ...
    def describe_phone_number_risk(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def query_phone_number_online_time_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.auth_code):
            query['AuthCode'] = request.auth_code
