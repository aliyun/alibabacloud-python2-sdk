...
class Client(OpenApiClient):
    ...
    *\
    ...
    def get_single_document_extract_result_with_options(self, request, runtime):
    ...
    def get_single_document_extract_result(self, request):
        runtime = util_models.RuntimeOptions()
        return self.get_single_document_extract_result_with_options(request, runtime)

    def submit_air_waybill_extract_job_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
    ...
    def submit_air_waybill_extract_job(self, request):
        runtime = util_models.RuntimeOptions()
        return self.submit_air_waybill_extract_job_with_options(request, runtime)

    def submit_air_waybill_extract_job_advance(self, request, runtime):
        # Step 0: init client
        ...
        if not UtilClient.is_unset(request.file_url_object):
            ...
            submit_air_waybill_extract_job_req.file_url = 'http://%s.%s/%s' % (TeaConverter.to_unicode(auth_response.body.bucket), TeaConverter.to_unicode(auth_response.body.endpoint), TeaConverter.to_unicode(auth_response.body.object_key))
    ...
    def submit_bill_of_lading_extract_job_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.file_name):
            query['FileName'] = request.file_name
    ...
    def submit_bill_of_lading_extract_job(self, request):
        runtime = util_models.RuntimeOptions()
        return self.submit_bill_of_lading_extract_job_with_options(request, runtime)

    def submit_bill_of_lading_extract_job_advance(self, request, runtime):
        # Step 0: init client
        access_key_id = self._credential.get_access_key_id()
        access_key_secret = self._credential.get_access_key_secret()
        security_token = self._credential.get_security_token()
        ...
        if not UtilClient.is_unset(request.file_url_object):
            ...
            oss_client.post_object(upload_request, oss_runtime)
            submit_bill_of_lading_extract_job_req.file_url = 'http://%s.%s/%s' % (TeaConverter.to_unicode(auth_response.body.bucket), TeaConverter.to_unicode(auth_response.body.endpoint), TeaConverter.to_unicode(auth_response.body.object_key))
    ...
    def submit_export_declaration_sheet_extract_job_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.file_name):
            query['FileName'] = request.file_name
    ...
    def submit_export_declaration_sheet_extract_job(self, request):
        runtime = util_models.RuntimeOptions()
        return self.submit_export_declaration_sheet_extract_job_with_options(request, runtime)

    def submit_export_declaration_sheet_extract_job_advance(self, request, runtime):
        # Step 0: init client
        access_key_id = self._credential.get_access_key_id()
        access_key_secret = self._credential.get_access_key_secret()
        security_token = self._credential.get_security_token()
        ...
        if not UtilClient.is_unset(request.file_url_object):
            ...
            oss_client.post_object(upload_request, oss_runtime)
            submit_export_declaration_sheet_extract_job_req.file_url = 'http://%s.%s/%s' % (TeaConverter.to_unicode(auth_response.body.bucket), TeaConverter.to_unicode(auth_response.body.endpoint), TeaConverter.to_unicode(auth_response.body.object_key))
    ...
    def submit_invoice_extract_job_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.file_name):
            query['FileName'] = request.file_name
    ...
    def submit_invoice_extract_job(self, request):
        runtime = util_models.RuntimeOptions()
        return self.submit_invoice_extract_job_with_options(request, runtime)

    def submit_invoice_extract_job_advance(self, request, runtime):
        # Step 0: init client
        access_key_id = self._credential.get_access_key_id()
        access_key_secret = self._credential.get_access_key_secret()
        security_token = self._credential.get_security_token()
        ...
        if not UtilClient.is_unset(request.file_url_object):
            ...
            oss_client.post_object(upload_request, oss_runtime)
            submit_invoice_extract_job_req.file_url = 'http://%s.%s/%s' % (TeaConverter.to_unicode(auth_response.body.bucket), TeaConverter.to_unicode(auth_response.body.endpoint), TeaConverter.to_unicode(auth_response.body.object_key))
