...
class CancelUpsertCollectionDataJobRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(CancelUpsertCollectionDataJobRequest, self).to_map()
        if _map is not None:
            return _map
...
class CancelUpsertCollectionDataJobResponseBody(TeaModel):
    ...
    def to_map(self):
        _map = super(CancelUpsertCollectionDataJobResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class CancelUpsertCollectionDataJobResponse(TeaModel):
    def __init__(self, headers=None, status_code=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.status_code = status_code  # type: int
        self.body = body  # type: CancelUpsertCollectionDataJobResponseBody
    ...
    def to_map(self):
        _map = super(CancelUpsertCollectionDataJobResponse, self).to_map()
        if _map is not None:
            return _map
...
class GetUpsertCollectionDataJobRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(GetUpsertCollectionDataJobRequest, self).to_map()
        if _map is not None:
            return _map
...
class GetUpsertCollectionDataJobResponseBodyJob(TeaModel):
    ...
    def to_map(self):
        _map = super(GetUpsertCollectionDataJobResponseBodyJob, self).to_map()
        if _map is not None:
            return _map
...
class GetUpsertCollectionDataJobResponseBody(TeaModel):
    ...
    def to_map(self):
        _map = super(GetUpsertCollectionDataJobResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class GetUpsertCollectionDataJobResponse(TeaModel):
    def __init__(self, headers=None, status_code=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.status_code = status_code  # type: int
        self.body = body  # type: GetUpsertCollectionDataJobResponseBody
    ...
    def to_map(self):
        _map = super(GetUpsertCollectionDataJobResponse, self).to_map()
        if _map is not None:
            return _map
...
class QueryContentShrinkRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(QueryContentShrinkRequest, self).to_map()
        if _map is not None:
            return _map
...
class QueryContentResponseBodyMatchesMatchList(TeaModel):
    def __init__(self, content=None, file_name=None, file_url=None, id=None, loader_metadata=None, metadata=None,
                 rerank_score=None, retrieval_source=None, score=None, vector=None):
        self.content = content  # type: str
        self.file_name = file_name  # type: str
        self.file_url = file_url  # type: str
        self.id = id  # type: str
        ...
        self.metadata = metadata  # type: dict[str, str]
        self.rerank_score = rerank_score  # type: float
...
class QueryContentResponseBodyWindowMatchesWindowMatchesWindowMatchWindowMatch(TeaModel):
    ...
    def to_map(self):
        _map = super(QueryContentResponseBodyWindowMatchesWindowMatchesWindowMatchWindowMatch, self).to_map()
        if _map is not None:
            return _map
...
class QueryContentResponseBodyWindowMatchesWindowMatchesWindowMatch(TeaModel):
    def __init__(self, window_match=None):
        self.window_match = window_match  # type: list[QueryContentResponseBodyWindowMatchesWindowMatchesWindowMatchWindowMatch]
    ...
    def to_map(self):
        _map = super(QueryContentResponseBodyWindowMatchesWindowMatchesWindowMatch, self).to_map()
        if _map is not None:
            return _map
...
class QueryContentResponseBodyWindowMatchesWindowMatches(TeaModel):
    def __init__(self, window_match=None):
        self.window_match = window_match  # type: QueryContentResponseBodyWindowMatchesWindowMatchesWindowMatch
    ...
    def to_map(self):
        _map = super(QueryContentResponseBodyWindowMatchesWindowMatches, self).to_map()
        if _map is not None:
            return _map
...
class QueryContentResponseBodyWindowMatches(TeaModel):
    def __init__(self, window_matches=None):
        self.window_matches = window_matches  # type: list[QueryContentResponseBodyWindowMatchesWindowMatches]
    ...
    def to_map(self):
        _map = super(QueryContentResponseBodyWindowMatches, self).to_map()
        if _map is not None:
            return _map
...
class QueryContentResponseBody(TeaModel):
    def __init__(self, embedding_tokens=None, matches=None, message=None, request_id=None, status=None, usage=None,
        ...
        self.window_matches = window_matches  # type: QueryContentResponseBodyWindowMatches
...
class UpsertCollectionDataAsyncRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(UpsertCollectionDataAsyncRequest, self).to_map()
        if _map is not None:
            return _map
...
class UpsertCollectionDataAsyncAdvanceRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(UpsertCollectionDataAsyncAdvanceRequest, self).to_map()
        if _map is not None:
            return _map
...
class UpsertCollectionDataAsyncResponseBody(TeaModel):
    ...
    def to_map(self):
        _map = super(UpsertCollectionDataAsyncResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class UpsertCollectionDataAsyncResponse(TeaModel):
    def __init__(self, headers=None, status_code=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.status_code = status_code  # type: int
        self.body = body  # type: UpsertCollectionDataAsyncResponseBody
    ...
    def to_map(self):
        _map = super(UpsertCollectionDataAsyncResponse, self).to_map()
        if _map is not None:
            return _map
