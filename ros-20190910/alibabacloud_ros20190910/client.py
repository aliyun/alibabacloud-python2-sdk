...
class Client(OpenApiClient):
    ...
    *\
    ...
    def deregister_resource_type_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
    ...
    def deregister_resource_type(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def list_resource_type_registrations(self, request):
        runtime = util_models.RuntimeOptions()
        return self.list_resource_type_registrations_with_options(request, runtime)

    def list_resource_type_versions_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.resource_type):
            query['ResourceType'] = request.resource_type
    ...
    def list_resource_type_versions(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def register_resource_type_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.client_token):
            query['ClientToken'] = request.client_token
    ...
    def register_resource_type(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def set_resource_type_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
    ...
    def set_resource_type(self, request):
        runtime = util_models.RuntimeOptions()
