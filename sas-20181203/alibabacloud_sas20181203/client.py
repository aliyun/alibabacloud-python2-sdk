...
class Client(OpenApiClient):
    ...
    *\
    ...
    def create_jenkins_image_scan_task_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
    ...
    def create_jenkins_image_scan_task(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def list_image_analysis_rule_project_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.source_ip):
            query['SourceIp'] = request.source_ip
    ...
    def list_image_analysis_rule_project(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def submit_image_analysis_output_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.source_ip):
            query['SourceIp'] = request.source_ip
    ...
    def submit_image_analysis_output(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def update_jenkins_image_scan_task_status_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.source_ip):
            query['SourceIp'] = request.source_ip
    ...
    def update_jenkins_image_scan_task_status(self, request):
        runtime = util_models.RuntimeOptions()
        return self.update_jenkins_image_scan_task_status_with_options(request, runtime)

    def upload_analyzer_runtime_log_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.source_ip):
            query['SourceIp'] = request.source_ip
    ...
    def upload_analyzer_runtime_log(self, request):
        runtime = util_models.RuntimeOptions()
