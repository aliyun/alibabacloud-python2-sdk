...
class Client(OpenApiClient):
    ...
    *\
    ...
    def segment_green_screen_video_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        req = open_api_models.OpenApiRequest(
            body=UtilClient.to_map(request)
        )
    ...
    def segment_green_screen_video(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def segment_green_screen_video_advance(self, request, runtime):
        ...
        segment_green_screen_video_req.video_url = 'http://%s.%s/%s' % (TeaConverter.to_unicode(auth_response.bucket), TeaConverter.to_unicode(auth_response.endpoint), TeaConverter.to_unicode(auth_response.object_key))
    ...
    def segment_half_body_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        req = open_api_models.OpenApiRequest(
            body=UtilClient.to_map(request)
        )
    ...
    def segment_half_body(self, request):
        runtime = util_models.RuntimeOptions()
        return self.segment_half_body_with_options(request, runtime)

    def segment_half_body_advance(self, request, runtime):
        # Step 0: init client
        access_key_id = self._credential.get_access_key_id()
        access_key_secret = self._credential.get_access_key_secret()
        auth_config = rpc_models.Config(
        ...
        oss_client.post_object(upload_request, oss_runtime)
        segment_half_body_req.video_url = 'http://%s.%s/%s' % (TeaConverter.to_unicode(auth_response.bucket), TeaConverter.to_unicode(auth_response.endpoint), TeaConverter.to_unicode(auth_response.object_key))
        segment_half_body_resp = self.segment_half_body_with_options(segment_half_body_req, runtime)
        return segment_half_body_resp

    def segment_video_body_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        req = open_api_models.OpenApiRequest(
            body=UtilClient.to_map(request)
        )
    ...
    def segment_video_body(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def segment_video_body_advance(self, request, runtime):
        ...
        oss_client.post_object(upload_request, oss_runtime)
        segment_video_body_req.video_url = 'http://%s.%s/%s' % (TeaConverter.to_unicode(auth_response.bucket), TeaConverter.to_unicode(auth_response.endpoint), TeaConverter.to_unicode(auth_response.object_key))
