...
class Client(OpenApiClient):
    ...
    *\
    ...
    def confirm_avatar_2d_train_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
    ...
    def confirm_avatar_2d_train(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def submit_avatar_video_task_with_options(self, tmp_req, runtime):
        UtilClient.validate_model(tmp_req)
    ...
    def submit_avatar_video_task(self, request):
        runtime = util_models.RuntimeOptions()
