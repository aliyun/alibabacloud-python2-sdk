...
class GetVideoTaskInfoResponseBodyDataTaskResult(TeaModel):
    def __init__(self, fail_code=None, fail_reason=None, subtitles_url=None, video_duration=None, video_url=None,
...
class QueryAvatarResponseBodyData(TeaModel):
    def __init__(self, avatar_type=None, description=None, image=None, model_type=None, name=None, portrait=None,
...
class QueryAvatarListResponseBodyDataList(TeaModel):
    def __init__(self, avatar_type=None, code=None, description=None, image=None, model_type=None, name=None,
                 portrait=None, supported_resolutions=None):
        self.avatar_type = avatar_type  # type: str
        self.code = code  # type: str
        self.description = description  # type: str
        self.image = image  # type: str
...
class SubmitAudioTo2DAvatarVideoTaskRequest(TeaModel):
    def __init__(self, app=None, avatar_info=None, tenant_id=None, title=None, url=None, video_info=None):
...
class SubmitAudioTo2DAvatarVideoTaskShrinkRequest(TeaModel):
    def __init__(self, app_shrink=None, avatar_info_shrink=None, tenant_id=None, title=None, url=None,
