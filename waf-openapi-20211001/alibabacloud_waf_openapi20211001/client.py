...
class Client(OpenApiClient):
    ...
    *\
    ...
    def describe_instance_compatible_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.region_id):
            query['RegionId'] = request.region_id
    ...
    def describe_instance_compatible(self, request):
        runtime = util_models.RuntimeOptions()
        return self.describe_instance_compatible_with_options(request, runtime)

    def describe_instance_extend_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
    ...
    def describe_instance_extend(self, request):
        runtime = util_models.RuntimeOptions()
