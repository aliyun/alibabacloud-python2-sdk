...
class PredictClassifierModelRequest(TeaModel):
    def __init__(self, auto_prediction=None, binary_to_text=None, body=None, classifier_id=None, content=None):
...
class PredictPreTrainModelRequest(TeaModel):
    def __init__(self, binary_to_text=None, body=None, content=None, service_name=None, service_version=None):
        self.binary_to_text = binary_to_text  # type: bool
        self.body = body  # type: str
        self.content = content  # type: str
        self.service_name = service_name  # type: str
    ...
    def to_map(self):
        _map = super(PredictPreTrainModelRequest, self).to_map()
        if _map is not None:
            return _map
...
class PredictPreTrainModelResponseBody(TeaModel):
    ...
    def to_map(self):
        _map = super(PredictPreTrainModelResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class PredictPreTrainModelResponse(TeaModel):
    def __init__(self, headers=None, status_code=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.status_code = status_code  # type: int
        self.body = body  # type: PredictPreTrainModelResponseBody
    ...
    def to_map(self):
        _map = super(PredictPreTrainModelResponse, self).to_map()
        if _map is not None:
            return _map
