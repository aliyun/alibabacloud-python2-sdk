...
NAME = "alibabacloud_dataworks-public20200518_py2" or "alibabacloud-package"
...
REQUIRES = [
    ...
    "alibabacloud_gateway_pop_py2>=0.0.4, <1.0.0",
...
setup(
    ...
    url=URL,
    keywords=["alibabacloud","dataworks","public20200518","py2"],
