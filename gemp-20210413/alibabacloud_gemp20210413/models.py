...
class CreateEscalationPlanRequestEscalationPlanRulesEscalationPlanStrategies(TeaModel):
    def __init__(self, notice_channels=None, notice_objects=None, notice_time=None):
        # 升级通知策略
...
class CreateProblemRequest(TeaModel):
    def __init__(self, affect_service_ids=None, client_token=None, discover_time=None, incident_id=None,
                 ...
                 problem_status=None, progress_summary=None, recovery_time=None, related_service_id=None, service_group_ids=None):
        # 影响服务列表
...
class CreateRouteRuleRequestRouteChildRules(TeaModel):
    def __init__(self, conditions=None, monitor_source_id=None):
        # 条件
...
class CreateRouteRuleRequest(TeaModel):
    def __init__(self, assign_object_id=None, assign_object_type=None, client_token=None, effection=None,
                 enable_status=None, incident_level=None, match_count=None, notify_channels=None, related_service_id=None,
...
class CreateServiceGroupRequest(TeaModel):
    def __init__(self, client_token=None, enable_webhook=None, service_group_description=None,
                 service_group_name=None, user_ids=None, webhook_link=None, webhook_type=None):
        # 幂等号
        self.client_token = client_token  # type: str
...
class GetIncidentResponseBodyData(TeaModel):
    def __init__(self, assign_user_id=None, assign_user_name=None, assign_user_phone=None, create_time=None,
                 ...
                 incident_number=None, incident_status=None, incident_title=None, is_manual=None, is_upgrade=None, problem_id=None,
                 problem_number=None, related_service_description=None, related_service_id=None, related_service_name=None,
...
class GetProblemResponseBodyData(TeaModel):
    def __init__(self, cancel_problem_operate_logs=None, cancel_reason=None, cancel_reason_description=None,
                 ...
                 recovery_time=None, related_service_id=None, replay_problem_operate_logs=None,
...
class GetProblemPreviewResponseBodyDataProblem(TeaModel):
    def __init__(self, coordination_groups=None, create_time=None, discover_time=None, effection_services=None,
                 ...
                 recovery_time=None, related_service_id=None, service_name=None):
        # 应急协同组
...
class GetRouteRuleResponseBodyDataEventRouteChildRules(TeaModel):
    def __init__(self, child_route_rule_id=None, conditions=None, is_valid_child_rule=None,
                 monitor_integration_config_id=None, monitor_source_id=None, monitor_source_name=None, parent_rule_id=None):
        # 子规则ID
...
class GetRouteRuleResponseBodyData(TeaModel):
    def __init__(self, assign_object_id=None, assign_object_name=None, assign_object_type=None, create_time=None,
                 effection=None, enable_status=None, event_route_child_rules=None, incident_level=None, match_count=None,
                 notify_channel_names=None, notify_channels=None, related_service_id=None, related_service_name=None,
                 route_rule_id=None, route_type=None, rule_name=None, time_window=None, update_time=None):
        # 事件分派对象ID（服务组ID 或用户ID）
        self.assign_object_id = assign_object_id  # type: long
        # 通知对象名称
...
class ListAlertsResponseBodyData(TeaModel):
    def __init__(self, alert_id=None, alert_level=None, alert_source_name=None, create_time=None,
                 first_event_time=None, related_service_name=None, route_rule_id=None, source_event_count=None, title=None):
        # 报警ID
...
class ListDataReportForServiceGroupResponseBodyData(TeaModel):
    def __init__(self, escalation_incident_count=None, finish_proportion=None, incident_count=None,
                 mean_time_to_acknowledge=None, mean_time_to_repair=None, service_group_id=None, service_group_name=None,
                 un_acknowledged_escalation_incident_count=None, un_finish_escalation_incident_count=None):
        # 升级事件数量
        self.escalation_incident_count = escalation_incident_count  # type: long
        # 完结率
...
class ListRouteRulesRequest(TeaModel):
    def __init__(self, client_token=None, page_number=None, page_size=None, rule_name=None, service_name=None):
        # 幂等号
        self.client_token = client_token  # type: str
        # 第几页
        self.page_number = page_number  # type: int
...
class ListRouteRulesResponseBodyData(TeaModel):
    def __init__(self, assign_object_id=None, assign_object_type=None, create_time=None, effection=None,
                 enable_status=None, incident_level=None, match_count=None, related_service_id=None, related_service_name=None,
                 route_rule_id=None, route_type=None, rule_name=None, tenant_ram_id=None, time_window=None, time_window_unit=None,
                 update_time=None):
        # 事件分派对象ID（服务组ID 或用户ID）
        self.assign_object_id = assign_object_id  # type: long
        # 事件分派对象类型 SERVICEGROUP 服务组  USER 单个用户
...
class UpdateProblemRequest(TeaModel):
    def __init__(self, feedback=None, level=None, main_handler_id=None, preliminary_reason=None, problem_id=None,
                 problem_name=None, progress_summary=None, related_service_id=None, service_group_ids=None):
        # 舆情反馈
        self.feedback = feedback  # type: str
        # 故障等级
        self.level = level  # type: str
...
class UpdateRouteRuleRequestRouteChildRules(TeaModel):
    def __init__(self, child_route_rule_id=None, conditions=None, is_valid_child_rule=None, monitor_source_id=None):
        # 子规则ID 不填表示新增
        self.child_route_rule_id = child_route_rule_id  # type: long
        # 条件
...
class UpdateRouteRuleRequest(TeaModel):
    def __init__(self, assign_object_id=None, assign_object_type=None, client_token=None, effection=None,
                 incident_level=None, match_count=None, notify_channels=None, related_service_id=None, route_child_rules=None,
...
class UpdateServiceGroupRequest(TeaModel):
    def __init__(self, client_token=None, enable_webhook=None, service_group_description=None,
                 service_group_id=None, service_group_name=None, user_ids=None, webhook_link=None, webhook_type=None):
        # 幂等号
        self.client_token = client_token  # type: str
        # ENABLE 启用 DISABLE 禁用
        self.enable_webhook = enable_webhook  # type: str
