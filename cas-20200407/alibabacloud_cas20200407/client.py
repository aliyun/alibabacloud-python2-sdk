...
class Client(OpenApiClient):
    ...
    *\
    ...
    def create_csr_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
    ...
    def delete_csr_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
    ...
    def get_csr_detail_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.csr_id):
            query['CsrId'] = request.csr_id
    ...
    def get_csr_detail(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def update_csr_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.csr_id):
            query['CsrId'] = request.csr_id
