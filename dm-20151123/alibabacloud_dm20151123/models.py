...
class GetRegionListRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(GetRegionListRequest, self).to_map()
        if _map is not None:
            return _map
...
class GetRegionListResponseBodyDataRegionList(TeaModel):
    def __init__(self, region=None, region_desc=None):
        self.region = region  # type: str
    ...
    def to_map(self):
        _map = super(GetRegionListResponseBodyDataRegionList, self).to_map()
        if _map is not None:
            return _map
...
class GetRegionListResponseBodyData(TeaModel):
    def __init__(self, region_list=None):
        self.region_list = region_list  # type: list[GetRegionListResponseBodyDataRegionList]
    ...
    def to_map(self):
        _map = super(GetRegionListResponseBodyData, self).to_map()
        if _map is not None:
            return _map
...
class GetRegionListResponseBody(TeaModel):
    def __init__(self, page_no=None, page_size=None, request_id=None, total=None, data=None):
        ...
        self.data = data  # type: GetRegionListResponseBodyData
