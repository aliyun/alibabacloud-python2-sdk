...
class AddFCTriggerRequest(TeaModel):
    def __init__(self, event_meta_name=None, event_meta_version=None, function_arn=None, notes=None, role_arn=None,
                 source_arn=None, trigger_arn=None):
...
class DeleteFCTriggerRequest(TeaModel):
    def __init__(self, trigger_arn=None):
        # The trigger that corresponds to the Function Compute service.
        self.trigger_arn = trigger_arn  # type: str
...
class DescribeCdnOrderCommodityCodeRequest(TeaModel):
    def __init__(self, commodity_code=None, owner_id=None, security_token=None):
    ...
    def to_map(self):
        _map = super(DescribeCdnOrderCommodityCodeRequest, self).to_map()
        if _map is not None:
            return _map
...
class DescribeCdnOrderCommodityCodeResponseBody(TeaModel):
    def __init__(self, order_commodity_code=None, request_id=None):
        # The commodity code that includes the organization unit.
        self.order_commodity_code = order_commodity_code  # type: str
        # The ID of the request.
        self.request_id = request_id  # type: str
    ...
    def to_map(self):
        _map = super(DescribeCdnOrderCommodityCodeResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class DescribeCdnOrderCommodityCodeResponse(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribeCdnOrderCommodityCodeResponse, self).to_map()
        if _map is not None:
            return _map
...
class DescribeDomainCnameResponseBodyCnameDatas(TeaModel):
    def __init__(self, data=None):
        self.data = data  # type: list[DescribeDomainCnameResponseBodyCnameDatasData]
    ...
    def to_map(self):
        _map = super(DescribeDomainCnameResponseBodyCnameDatas, self).to_map()
        if _map is not None:
            return _map
...
class DescribeDomainCnameResponseBody(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribeDomainCnameResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class DescribeDomainCnameResponse(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribeDomainCnameResponse, self).to_map()
        if _map is not None:
            return _map
...
class DescribeIpStatusRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribeIpStatusRequest, self).to_map()
        if _map is not None:
            return _map
...
class DescribeIpStatusResponseBody(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribeIpStatusResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class DescribeIpStatusResponse(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribeIpStatusResponse, self).to_map()
        if _map is not None:
            return _map
...
class DescribePreloadDetailByIdRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribePreloadDetailByIdRequest, self).to_map()
        if _map is not None:
            return _map
...
class DescribePreloadDetailByIdResponseBodyUrlDetailsUrls(TeaModel):
    def __init__(self, description=None, success=None, url=None):
        self.description = description  # type: str
    ...
    def to_map(self):
        _map = super(DescribePreloadDetailByIdResponseBodyUrlDetailsUrls, self).to_map()
        if _map is not None:
            return _map
...
class DescribePreloadDetailByIdResponseBodyUrlDetails(TeaModel):
    def __init__(self, creation_time=None, domain=None, end_time=None, process=None, ret_code=None, status=None,
                 task_id=None, urls=None):
        ...
        self.status = status  # type: str
        self.task_id = task_id  # type: str
        self.urls = urls  # type: list[DescribePreloadDetailByIdResponseBodyUrlDetailsUrls]
    ...
    def to_map(self):
        _map = super(DescribePreloadDetailByIdResponseBodyUrlDetails, self).to_map()
        if _map is not None:
            return _map
...
class DescribePreloadDetailByIdResponseBody(TeaModel):
    def __init__(self, request_id=None, total_count=None, url_details=None):
        self.request_id = request_id  # type: str
        self.total_count = total_count  # type: long
        self.url_details = url_details  # type: list[DescribePreloadDetailByIdResponseBodyUrlDetails]
    ...
    def to_map(self):
        _map = super(DescribePreloadDetailByIdResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class DescribePreloadDetailByIdResponse(TeaModel):
    ...
    def to_map(self):
        _map = super(DescribePreloadDetailByIdResponse, self).to_map()
        if _map is not None:
            return _map
...
class VerifyDomainOwnerRequest(TeaModel):
    def __init__(self, domain_name=None, global_resource_plan=None, verify_type=None):
        self.domain_name = domain_name  # type: str
