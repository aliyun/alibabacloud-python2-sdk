...
class CreateRecordIndexFileRequest(TeaModel):
    def __init__(self, app_id=None, channel_id=None, end_time=None, oss_bucket=None, oss_endpoint=None,
                 oss_object=None, owner_id=None, start_time=None, task_id=None):
        self.app_id = app_id  # type: str
        self.channel_id = channel_id  # type: str
    ...
    def to_map(self):
        _map = super(CreateRecordIndexFileRequest, self).to_map()
        if _map is not None:
            return _map
...
class CreateRecordIndexFileResponseBody(TeaModel):
    def __init__(self, duration=None, height=None, request_id=None, url=None, width=None):
    ...
    def to_map(self):
        _map = super(CreateRecordIndexFileResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class CreateRecordIndexFileResponse(TeaModel):
    def __init__(self, headers=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.body = body  # type: CreateRecordIndexFileResponseBody
    ...
    def to_map(self):
        _map = super(CreateRecordIndexFileResponse, self).to_map()
        if _map is not None:
            return _map
    ...
    def from_map(self, m=None):
        ...
        if m.get('headers') is not None:
            self.headers = m.get('headers')
        if m.get('body') is not None:
            temp_model = CreateRecordIndexFileResponseBody()
            self.body = temp_model.from_map(m['body'])
        return self
...
class DescribeRecordTasksRequest(TeaModel):
    def __init__(self, app_id=None, channel_id=None, end_time=None, owner_id=None, page_num=None, page_size=None,
                 start_time=None, status=None, task_ids=None):
        self.app_id = app_id  # type: str
        self.channel_id = channel_id  # type: str
        self.end_time = end_time  # type: str
        self.owner_id = owner_id  # type: long
    ...
    def to_map(self):
        _map = super(DescribeRecordTasksRequest, self).to_map()
        if _map is not None:
            return _map
...
class DescribeRecordTasksResponseBodyRecordTasksUserPanes(TeaModel):
    def __init__(self, pane_id=None, source=None, user_id=None):
        self.pane_id = pane_id  # type: int
    ...
    def to_map(self):
        _map = super(DescribeRecordTasksResponseBodyRecordTasksUserPanes, self).to_map()
        if _map is not None:
            return _map
...
class DescribeRecordTasksResponseBodyRecordTasks(TeaModel):
    def __init__(self, app_id=None, channel_id=None, create_time=None, status=None, sub_spec_users=None,
                 task_id=None, template_id=None, user_panes=None):
        self.app_id = app_id  # type: str
        self.channel_id = channel_id  # type: str
        self.create_time = create_time  # type: str
        ...
        self.task_id = task_id  # type: str
        self.template_id = template_id  # type: str
        self.user_panes = user_panes  # type: list[DescribeRecordTasksResponseBodyRecordTasksUserPanes]
    ...
    def to_map(self):
        _map = super(DescribeRecordTasksResponseBodyRecordTasks, self).to_map()
        if _map is not None:
            return _map
...
class DescribeRecordTasksResponseBody(TeaModel):
    def __init__(self, record_tasks=None, request_id=None, total_num=None, total_page=None):
        self.record_tasks = record_tasks  # type: list[DescribeRecordTasksResponseBodyRecordTasks]
        self.request_id = request_id  # type: str
        self.total_num = total_num  # type: long
        self.total_page = total_page  # type: long
    ...
    def to_map(self):
        _map = super(DescribeRecordTasksResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class DescribeRecordTasksResponse(TeaModel):
    def __init__(self, headers=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.body = body  # type: DescribeRecordTasksResponseBody
    ...
    def to_map(self):
        _map = super(DescribeRecordTasksResponse, self).to_map()
        if _map is not None:
            return _map
