...
NAME = "alibabacloud_cloudauth20201112_py2" or "alibabacloud-package"
DESCRIPTION = "Alibaba Cloud ID Verification (20201112) SDK Library for Python2"
AUTHOR = "Alibaba Cloud SDK"
...
setup(
    ...
    url=URL,
    keywords=["alibabacloud","cloudauth20201112","py2"],
