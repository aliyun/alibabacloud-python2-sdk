...
class BillingProcessMessageRequest(TeaModel):
    ...
    def to_map(self):
        _map = super(BillingProcessMessageRequest, self).to_map()
        if _map is not None:
            return _map
...
class BillingProcessMessageResponseBody(TeaModel):
    ...
    def to_map(self):
        _map = super(BillingProcessMessageResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class BillingProcessMessageResponse(TeaModel):
    def __init__(self, headers=None, status_code=None, body=None):
        ...
        self.body = body  # type: BillingProcessMessageResponseBody
    ...
    def to_map(self):
        _map = super(BillingProcessMessageResponse, self).to_map()
        if _map is not None:
            return _map
