...
class CreateDiskReplicaPairRequest(TeaModel):
    def __init__(self, bandwidth=None, charge_type=None, client_token=None, description=None,
                 ...
                 period=None, period_unit=None, source_region_id=None, source_zone_id=None):
...
class DescribeDiskReplicaPairsRequest(TeaModel):
    def __init__(self, max_results=None, next_token=None, pair_ids=None, region_id=None):
...
class DescribeDiskReplicaPairsResponseBodyReplicaPairs(TeaModel):
    def __init__(self, async_cycle=None, bandwidth=None, description=None, destination_disk_id=None,
                 destination_region=None, last_rpo=None, pair_name=None, replica_pair_id=None, source_disk_id=None, source_region=None,
                 status=None, status_message=None):
        self.async_cycle = async_cycle  # type: long
        self.bandwidth = bandwidth  # type: long
        self.description = description  # type: str
        self.destination_disk_id = destination_disk_id  # type: str
        self.destination_region = destination_region  # type: str
        self.last_rpo = last_rpo  # type: long
        self.pair_name = pair_name  # type: str
        self.replica_pair_id = replica_pair_id  # type: str
...
class DescribeRegionsRequest(TeaModel):
    def __init__(self, accept_language=None, resource_type=None):
...
class ModifyDiskReplicaPairRequest(TeaModel):
    def __init__(self, client_token=None, description=None, pair_name=None, region_id=None, replica_pair_id=None):
        self.client_token = client_token  # type: str
        self.description = description  # type: str
        self.pair_name = pair_name  # type: str
        self.region_id = region_id  # type: str
