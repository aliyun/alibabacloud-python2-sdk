...
class Client(OpenApiClient):
    ...
    *\
    ...
    def describe_lens_monitor_disks_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.disk_category):
            query['DiskCategory'] = request.disk_category
    ...
    def describe_lens_monitor_disks(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def describe_solution_instance_configuration_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.client_token):
            query['ClientToken'] = request.client_token
    ...
    def describe_solution_instance_configuration(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def get_disk_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.disk_id):
            query['DiskId'] = request.disk_id
    ...
    def query_dedicated_block_storage_cluster_disk_throughput_status_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.client_token):
            query['ClientToken'] = request.client_token
    ...
    def query_dedicated_block_storage_cluster_disk_throughput_status(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def set_dedicated_block_storage_cluster_disk_throughput_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.client_token):
            query['ClientToken'] = request.client_token
    ...
    def set_dedicated_block_storage_cluster_disk_throughput(self, request):
        runtime = util_models.RuntimeOptions()
