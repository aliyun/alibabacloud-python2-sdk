...
class EnableInsightRequest(TeaModel):
    def __init__(self, insight_type=None):
        self.insight_type = insight_type  # type: str

    def validate(self):
        pass

    def to_map(self):
        _map = super(EnableInsightRequest, self).to_map()
        if _map is not None:
            return _map
...
class EnableInsightResponseBody(TeaModel):
    ...
    def to_map(self):
        _map = super(EnableInsightResponseBody, self).to_map()
        if _map is not None:
            return _map
...
class EnableInsightResponse(TeaModel):
    def __init__(self, headers=None, status_code=None, body=None):
        self.headers = headers  # type: dict[str, str]
        self.status_code = status_code  # type: int
        self.body = body  # type: EnableInsightResponseBody
    ...
    def to_map(self):
        _map = super(EnableInsightResponse, self).to_map()
        if _map is not None:
            return _map
