...
class CreateApiRequest(TeaModel):
    def __init__(self, allow_signature_method=None, api_name=None, auth_type=None, description=None,
                 error_code_samples=None, fail_result_sample=None, group_id=None, open_id_connect_config=None, request_config=None,
                 request_paramters=None, result_descriptions=None, result_sample=None, result_type=None, security_token=None,
...
class DescribeApiResponseBodyServiceConfig(TeaModel):
    def __init__(self, aone_app_name=None, content_type_catagory=None, content_type_value=None,
                 function_compute_config=None, mock=None, mock_result=None, service_address=None, service_http_method=None,
                 service_path=None, service_protocol=None, service_timeout=None, service_vpc_enable=None, vpc_config=None):
...
class DescribeApiResponseBody(TeaModel):
    def __init__(self, allow_signature_method=None, api_id=None, api_name=None, auth_type=None,
                 constant_parameters=None, created_time=None, custom_system_parameters=None, deployed_infos=None, description=None,
                 error_code_samples=None, fail_result_sample=None, group_id=None, group_name=None, mock=None, mock_result=None,
                 modified_time=None, open_id_connect_config=None, origin_result_description=None, parameters_map_object=None,
                 region_id=None, request_config=None, request_id=None, request_parameters_object=None, result_sample=None,
...
class DescribeApiDocResponseBody(TeaModel):
    def __init__(self, api_id=None, api_name=None, body_format=None, deployed_time=None, description=None,
                 ...
                 http_protocol=None, mock=None, mock_result=None, origin_result_description=None, path=None, path_parameters=None,
                 post_body_description=None, post_body_type=None, region_id=None, request_body=None, request_headers=None,
                 request_id=None, request_mode=None, request_queries=None, result_sample=None, result_type=None,
                 service_timeout=None, service_vpc_enable=None, stage_name=None, vpc_name=None):
        self.api_id = api_id  # type: str
        self.api_name = api_name  # type: str
        self.body_format = body_format  # type: str
...
class DescribeApiGroupDetailResponseBodyDomainItemsDomainItem(TeaModel):
    def __init__(self, certificate_id=None, certificate_name=None, domain_binding_status=None,
                 domain_legal_status=None, domain_name=None, domain_name_resolution=None, domain_remark=None,
                 domain_web_socket_status=None):
        self.certificate_id = certificate_id  # type: str
...
class DescribeApiGroupDetailResponseBody(TeaModel):
    def __init__(self, billing_status=None, created_time=None, description=None, domain_items=None, group_id=None,
                 group_name=None, illegal_status=None, modified_time=None, region_id=None, request_id=None, stage_items=None,
...
class DescribeAppSecuritiesResponseBodyAppSecuritysAppSecurity(TeaModel):
    def __init__(self, app_key=None, app_secret=None, created_time=None, modified_time=None):
...
class DescribeAppsRequest(TeaModel):
    def __init__(self, app_id=None, app_name=None, page_number=None, page_size=None, security_token=None):
        self.app_id = app_id  # type: long
        self.app_name = app_name  # type: str
        self.page_number = page_number  # type: int
        self.page_size = page_size  # type: int
...
class DescribeDeployedApiResponseBody(TeaModel):
    def __init__(self, api_id=None, api_name=None, auth_type=None, body_format=None, constant_parameters=None,
                 deployed_time=None, error_code_samples=None, fail_result_sample=None, function_compute_config=None,
                 group_id=None, group_name=None, http_method=None, http_protocol=None, path=None, path_parameters=None,
                 post_body_description=None, post_body_type=None, region_id=None, request_body=None, request_headers=None,
                 request_id=None, request_mode=None, request_queries=None, result_sample=None, result_type=None,
                 service_address=None, service_fcenable=None, service_protocol=None, service_timeout=None, service_vpc_enable=None,
                 stage_name=None, system_parameters=None, visibility=None, vpc_name=None):
        self.api_id = api_id  # type: str
        self.api_name = api_name  # type: str
        self.auth_type = auth_type  # type: str
        self.body_format = body_format  # type: str
...
class ModifyApiRequest(TeaModel):
    def __init__(self, allow_signature_method=None, api_id=None, api_name=None, auth_type=None, description=None,
                 error_code_samples=None, fail_result_sample=None, group_id=None, open_id_connect_config=None, request_config=None,
                 request_paramters=None, result_descriptions=None, result_sample=None, result_type=None, security_token=None,
                 service_config=None, service_parameters=None, service_parameters_map=None, visibility=None,
                 web_socket_api_type=None):
