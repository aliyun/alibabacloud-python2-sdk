...
class Client(OpenApiClient):
    ...
    *\
    ...
    def create_read_dbinstance_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.auto_renew):
            query['AutoRenew'] = request.auto_renew
    ...
    def create_read_dbinstance(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def delete_dbdata_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.dbinstance_id):
            query['DBInstanceId'] = request.dbinstance_id
    ...
    def delete_dbdata(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def describe_dbinstance_access_white_list_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
        if not UtilClient.is_unset(request.dbinstance_id):
            query['DBInstanceId'] = request.dbinstance_id
    ...
    def describe_dbinstance_access_white_list(self, request):
        runtime = util_models.RuntimeOptions()
    ...
    def modify_dbinstance_access_white_list_with_options(self, request, runtime):
        UtilClient.validate_model(request)
        query = {}
    ...
    def modify_dbinstance_access_white_list(self, request):
        runtime = util_models.RuntimeOptions()
